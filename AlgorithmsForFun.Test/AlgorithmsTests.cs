...
public class AlgorithmsTests {
    ...
    [Theory]
    [InlineData(new[] {0, 0, 1}, "Python", new [] { "HTML","C#" }, new [] { "C#","Python" }, new [] { "Python","HTML" })]
    [InlineData(new[] {0, 1, 1}, "Java", new [] { "HTML","Java" }, new [] { "Java","Python" }, new [] { "Python","HTML" })]
    public void TournamentWinnerTest(int[] results, string expectedResult, params string[][]  competitions) {
        var result = Algorithms.TournamentWinner(competitions, results);
